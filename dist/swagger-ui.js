...
(function() {
  ...
  SwaggerUi = (function(_super) {
    ...
    function SwaggerUi() {
      this.showCustom = __bind(this.showCustom, this);
    ...
    SwaggerUi.prototype.render = function() {
      var _this = this;
      $('li.resource-selector').on('click', this.showCustom);
    ...
    SwaggerUi.prototype.showCustom = function(e) {
      var url;
      if (e != null) {
        e.preventDefault();
      }
      url = $(e.currentTarget).data('url');
      return this.updateSwaggerUi({
        discoveryUrl: url,
